<template>
    <div id="app">
        ...
        <div class="grid grid-rows-4 grid-flow-col gap-6">
            <div class="col">
                <div
                class="relative flex flex-col min-w-0 rounded break-words bg-white border-1 border-gray-300">
                ...
                <div class="flex-auto p-6">
                    ...
                    <div class="mb-4">
                        <button
                        class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded no-underlined bg-blue-600 text-white hover:bg-blue-600 py-1 px-2 leading-tight text-xs"
